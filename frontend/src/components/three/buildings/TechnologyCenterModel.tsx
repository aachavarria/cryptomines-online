...
function TechnologyCenterGLB({
  ...
  const { scene } = useGLTF("/assets/gbl/buildings/tech-center.glb");
...
export default function TechnologyCenterModel(props: BuildingComponentProps) {
  return (
    <Suspense fallback={null}>
      <TechnologyCenterGLB {...props} />
    </Suspense>
  );
}

useGLTF.preload("/assets/gbl/buildings/tech-center.glb");
