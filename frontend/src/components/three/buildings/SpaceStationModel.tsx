...
function SpaceStationGLB({
  ...
  const { scene } = useGLTF("/assets/gbl/buildings/space-station.glb");
...
export default function SpaceStationModel(props: BuildingComponentProps) {
  return (
    <Suspense fallback={null}>
      <SpaceStationGLB {...props} />
    </Suspense>
  );
}

useGLTF.preload("/assets/gbl/buildings/space-station.glb");
