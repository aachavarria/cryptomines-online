...
function ResidentialAreaGLB({
  ...
  const { scene } = useGLTF("/assets/gbl/buildings/residentials.glb");
...
export default function ResidentialAreaModel(props: BuildingComponentProps) {
  return (
    <Suspense fallback={null}>
      <ResidentialAreaGLB {...props} />
    </Suspense>
  );
}

useGLTF.preload("/assets/gbl/buildings/residentials.glb");
