...
function He3ExtractorGLB({
  ...
  const { scene } = useGLTF("/assets/gbl/buildings/gas-extractor.glb");
...
export default function He3ExtractorModel(props: BuildingComponentProps) {
  return (
    <Suspense fallback={null}>
      <He3ExtractorGLB {...props} />
    </Suspense>
  );
}

useGLTF.preload("/assets/gbl/buildings/gas-extractor.glb");
